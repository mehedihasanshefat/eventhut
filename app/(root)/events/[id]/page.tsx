...
import CheckoutButton from "@/components/shared/checkout-btn";
import {
  getEventById,
...
const EventDetailsPage = async ({ params, searchParams }: SearchParamProps) => {
  ...
  const relatedEvents = await getRelatedEventsByCategory({
    ...
    eventId: event._id,
    page: typeof sParams.page === "string" ? sParams.page : "1",
  });
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
                <div className="flex gap-3">
                  ...
                  <p className="p-medium-16 bg-grey-500/10 text-grey-500 rounded-full px-4 py-2.5">
                    {event.category.name}
                  </p>
                </div>
